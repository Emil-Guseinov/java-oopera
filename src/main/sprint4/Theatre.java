package main.sprint4;

import main.sprint4.person.*;

import main.sprint4.person.Actor;
import main.sprint4.person.Director;
import main.sprint4.person.Gender;
import main.sprint4.person.Person;
import main.sprint4.show.Ballet;
import main.sprint4.show.Opera;
import main.sprint4.show.Show;
...
public class Theatre {
     public static void main(String[] args) {
         ...
         Person musicAuthor = new Person("Мартин", "Мулл", Gender.MALE);// убрал классы    <---------
         ...
         Person choreographer = new Person("Эллен","Стюарт",Gender.FEMALE);

         Show fantasy = new Show ("Фэнтези",director1,120);
         Opera opera = new Opera("Проклятый замок", director2,160, musicAuthor,"Замок Чудовища.", 20);
         Ballet ballet = new Ballet("Красавица и Чудовище",director1,60,musicAuthor,"История преображения Чудовища через красоту и любовь Лиоры.",choreographer);
